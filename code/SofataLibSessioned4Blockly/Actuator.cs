...
namespace Softata
{
    public partial class SoftataLib
    {
        ...
        public  class Actuator
        {
            ...
            public  string GetValueRange(ActuatorDevice deviceType,Socket client, bool debug = true )
            {
            ...
            public  int Setup(ActuatorDevice deviceType, byte pinNumber)
            {
                ...
                string result = softatalib.SendMessage(Commands.groveActuator, client, pinNumber, (byte)GroveActuatorCmds.a_setupCMD, "OK:", (byte)deviceType);
