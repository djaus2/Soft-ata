...
namespace   Softata.ActionCommands
{
    ...
    public class CommandsPortal
    {
        ...
        //////////////////////////////////////////////////////////////////////////////////////////
        public string RunGenericMethod(Selection TargetCommand, Socket? client)
        {
            if(client==null)
                return "";
            using (this.selectedDeviceLoopVars  )
            {
                ...
                if (TargetDeviceType.Item.ToLower() == "deviceinput")
                {
                    if (!selectedDeviceLoopVars.foundRange) // Only get range once
                    {
                        ...
                        result = softatalib.SendTargetCommand((byte)TargetDeviceType.Index,client, (byte)1, (byte)subCmd, (byte)0xff, linkedListNo, null);
                        ...
                        if (!selectedDeviceLoopVars.foundRange)
                        {
                            ...
                            result = softatalib.SendTargetCommand((byte)TargetDeviceType.Index, client,1, subCmd, (byte)TargetDevice.Index);
                ...
                else if (TargetDeviceType.Item.ToLower() == "display")
                {
                    ...
                    else if (command.ToLower().Contains("misc"))
                    {
                        ...
                        string MiscCmds = softatalib.SendTargetCommand((byte)TargetDeviceType.Index, client,1, subCmd, (byte)TargetDevice.Index);
                ...
                if (!isMiscCMd)
                {
                    ...
                    string response = softatalib.SendTargetCommand((byte)TargetDeviceType.Index, client, (byte)pinn, (byte)TargetCommand.Index, targetDeviceIndex, linkedListNo, data);
