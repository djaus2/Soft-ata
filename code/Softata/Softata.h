...
#define APP_VERSION "12.200"  //Nb: As SoftataLib is updated, this is incremented even if no changes to Arduino code.
...
#define MAX_OF_DEVICE_TYPE  10
#define MAX_SENSORS         MAX_OF_DEVICE_TYPE
#define MAX_ACTUATORS       MAX_OF_DEVICE_TYPE
#define MAX_DISPLAYS        MAX_OF_DEVICE_TYPE
#define MAX_DEVICEINPUTS    MAX_OF_DEVICE_TYPE
