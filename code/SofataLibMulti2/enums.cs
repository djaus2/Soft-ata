...
namespace Softata.Enums
{
    ...
    public enum ConsoleTestType : byte
    {
        ...
        Servo = 3,
        Sensors = 4,
        Displays_Suite_of_Tests = 0x5,
        Displays_Individual_Cmds = 0x6,
        Displays_Generic = 0x7,
        Loopback = 8,
        Analog_Potentiometer_Light_and_Sound = 0x9,
        USonicRange = 0xA,
        Potentiometer_and_Actuator = 0xB,
        GPS_Serial = 0xC,
        Test_OTA_Or_WDT = 0xD,
        Analog_Device_Raw = 0xE,
        MaxType = 0xF,       
        Undefined = 0xFF,
    }
